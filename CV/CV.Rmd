...
#              method = "lm", se= FALSE, color = "firebrick1", size = 2) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position="none", axis.ticks = element_blank(), text=element_text(size=14)) +
  ylab("") + xlab("")
...
#              method = "lm", se= FALSE, color = "firebrick1", size = 2) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1), text=element_text(size=14), axis.ticks = element_blank()) +
  xlab("")
