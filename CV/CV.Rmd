...
www: www.icarehb.com/team/cascalheira
...
# Needs updated file
cascalheira_data<-bibliometrix::readFiles("../CV/WOS.bib")
cascalheira <- convert2df(cascalheira_data, dbsource = "wos", format = "bibtex")
wos <- Hindex(cascalheira, field = "author", elements = c("CASCALHEIRA J"), sep = ";", years = 10)$H
...
tribble(
  ...
  "Pedro Horta (Ph.D. thesis, University of Algarve, Portugal)", "2017-",
